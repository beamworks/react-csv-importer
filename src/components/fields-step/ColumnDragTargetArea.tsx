...
const TargetBox: React.FC<{
  ...
  const {
    l10n_optionalAriaLabel,
    l10n_requiredAriaLabel,
    l10n_boxPlaceholder,
    l10n_getBoxValueAction,
    l10n_clear
  } = useLocale('TargetBox');
  ...
  return (
    <section
      ...
      aria-label={`${field.label} (${
        field.isOptional ? l10n_optionalAriaLabel : l10n_requiredAriaLabel
      })`}
      ref={containerRef}
    >
      ...
      <div className="CSVImporter_ColumnDragTargetArea__boxValue">
        ...
        {dragState && !dragState.pointerStartInfo ? (
          <div className="CSVImporter_ColumnDragTargetArea__boxValueAction">
            <IconButton
              label={l10n_getBoxValueAction(dragState.column.code)}
              small
              type="forward"
...
export const ColumnDragTargetArea: React.FC<{
  ...
  const { l10n_ariaLabel } = useLocale('ColumnDragTargetArea');
